...
var MeetingProvider = function MeetingProvider(_ref) {
  ...
  var _useState21 = useState('TRANSLATION_STOPPED'),
  ...
  var join = function join() {
    ...
    meeting.on('translation-state-changed', _handle_translation_state_changed);
    meeting.on('translation-text', _handle_translation_text);
    meeting.on('translation-language-changed', _handle_translation_language_changed);
...
var useTranslation = function useTranslation(_temp) {
  var _ref = _temp === void 0 ? {} : _temp,
    _ref$onTranslationSta = _ref.onTranslationStateChanged,
    onTranslationStateChanged = _ref$onTranslationSta === void 0 ? function () {
      return Promise.resolve();
    } : _ref$onTranslationSta,
    _ref$onTranslationLan = _ref.onTranslationLanguageChanged,
    onTranslationLanguageChanged = _ref$onTranslationLan === void 0 ? function () {
      return Promise.resolve();
    } : _ref$onTranslationLan,
    _ref$onTranslationTex = _ref.onTranslationText,
    onTranslationText = _ref$onTranslationTex === void 0 ? function () {
      return Promise.resolve();
  ...
  var startTranslation = function startTranslation(config) {
    try {
      return Promise.resolve(mMeeting.meeting.startTranslation(config));
    } catch (e) {
      return Promise.reject(e);
    }
  };
  var changeTranslationLanguage = function changeTranslationLanguage(language) {
    try {
  ...
  var stopTranslation = function stopTranslation() {
    try {
